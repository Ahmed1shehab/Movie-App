  ...
  void getPost() async {
    ...
    try {
      ...
      http.Response result = await http.get(
        Uri.parse("https://api.themoviedb.org/3/movie/popular?api_key=df7861568de66e24a1c2de6ab4900e1d"),
      );
      ...
      if (data['results'] != null && data['results'] is List) {
        ...
        emit(PostError('Invalid API response'));
      }
    } catch (e) {
